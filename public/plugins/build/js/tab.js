    ...
    var _tab = {
        ...
        createTabDom: function() {
            ...
            var tpl = [
                    ...
                    '<ul class="layui-tab-title" style="width: calc(100% - 60px)">',
                    '<li class="layui-this" lay-id="-1" data-url="' + _config.mainUrl + '"><i class="layui-icon">&#xe68e;</i> 首页</li>',
                    '</ul>',
                    '<div class="kit-tab-tool" style="right:-1px">操作&nbsp;<i class="fa fa-caret-down"></i></div>',
                    '<div class="kit-tab-tool-body layui-anim layui-anim-upbit" style="right:-1px">',
                    '<ul>',
